...
const urlBackEndOnline =
  "http://yvonnicksolon-server.eddi.cloud/projet-3-jarvis-back/public/api/"; // à changer !!!!!!!!

// to start app when backend is down
// export const skipLogin = "";

const apiEndPoints = {
  urlBackOffice: `${realBackYvo}/projet-3-jarvis-back/public/backoffice`, // à changer !!!!!!!!
  urlSignUp: `${realBackYvo}/projet-3-jarvis-back/public/`, // à changer !!!!!!!!
